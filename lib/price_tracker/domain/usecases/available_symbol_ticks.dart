...
class AvailableTicks extends Usecase<Stream<SymbolTick>?, SymbolParams?> {
  final Repository _repository;

  AvailableTicks(this._repository);

  @override
  Future<Either<UIError, Stream<SymbolTick>?>> call([params]) async {
    try {
      final results = _repository.getSymbolTick(params.symbol);
