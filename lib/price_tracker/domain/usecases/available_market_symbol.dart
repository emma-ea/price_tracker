...
class AvailableSymbols extends Usecase<List<MarketSymbol>?, NoParams> {
  ...
  @override
  Future<Either<UIError, List<MarketSymbol>?>> call([params]) async {
    try {
      final results = await _repository.getMarketSymbols();
